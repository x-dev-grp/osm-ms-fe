...
const PATCH = {
  en: {
    ...
    'HR.ATTENDANCE.STATUS.PUBLIC_HOLIDAY': 'Public holiday',
    'HR.POINTAGE.KIOSK.TITLE': 'Clock in / out',
    'HR.POINTAGE.KIOSK.SUBTITLE': 'Enter your CIN, then punch in or out.',
    'HR.POINTAGE.KIOSK.CIN_LABEL': 'CIN number',
    'HR.POINTAGE.KIOSK.CIN_REQUIRED': 'Please enter your CIN',
    'HR.POINTAGE.KIOSK.IDENTIFY': 'Identify',
    'HR.POINTAGE.KIOSK.RESET': 'New',
    'HR.POINTAGE.KIOSK.EMPLOYEE_NOT_FOUND': 'No employee found for this CIN',
    'HR.POINTAGE.KIOSK.LOAD_ERROR': 'Unable to load attendance',
    'HR.POINTAGE.KIOSK.PUNCH_ERROR': 'Punch rejected',
    'HR.POINTAGE.KIOSK.CHECK_IN_OK': 'Check-in recorded',
    'HR.POINTAGE.KIOSK.CHECK_OUT_OK': 'Check-out recorded',
    'HR.POINTAGE.KIOSK.TODAY': 'Today',
    'HR.POINTAGE.KIOSK.CHECK_IN': 'Check-in',
    'HR.POINTAGE.KIOSK.CHECK_OUT': 'Check-out',
    'HR.POINTAGE.KIOSK.WORKED_HOURS': 'Worked hours',
    'HR.POINTAGE.KIOSK.BUTTON_IN': 'Check in',
    'HR.POINTAGE.KIOSK.BUTTON_OUT': 'Check out',
    'HR.POINTAGE.KIOSK.DAY_COMPLETE': "Today's punch is complete",
    'HR.POINTAGE.KIOSK.BACK_LIST': 'Attendance list',
    'HR.POINTAGE.KIOSK.NO_JOB': 'No job title'
  },
  fr: {
    ...
    'HR.ATTENDANCE.STATUS.LEAVE': 'Congé',
    'HR.ATTENDANCE.STATUS.PUBLIC_HOLIDAY': 'Jour férié',
    'HR.POINTAGE.KIOSK.TITLE': 'Pointage',
    'HR.POINTAGE.KIOSK.SUBTITLE': 'Saisissez votre CIN puis pointez votre entrée ou sortie.',
    'HR.POINTAGE.KIOSK.CIN_LABEL': 'Numéro CIN',
    'HR.POINTAGE.KIOSK.CIN_REQUIRED': 'Veuillez saisir votre CIN',
    'HR.POINTAGE.KIOSK.IDENTIFY': 'Identifier',
    'HR.POINTAGE.KIOSK.RESET': 'Nouveau',
    'HR.POINTAGE.KIOSK.EMPLOYEE_NOT_FOUND': 'Aucun employé trouvé pour ce CIN',
    'HR.POINTAGE.KIOSK.LOAD_ERROR': 'Impossible de charger le pointage',
    'HR.POINTAGE.KIOSK.PUNCH_ERROR': 'Pointage refusé',
    'HR.POINTAGE.KIOSK.CHECK_IN_OK': 'Entrée enregistrée',
    'HR.POINTAGE.KIOSK.CHECK_OUT_OK': 'Sortie enregistrée',
    'HR.POINTAGE.KIOSK.TODAY': "Aujourd'hui",
    'HR.POINTAGE.KIOSK.CHECK_IN': 'Entrée',
    'HR.POINTAGE.KIOSK.CHECK_OUT': 'Sortie',
    'HR.POINTAGE.KIOSK.WORKED_HOURS': 'Heures travaillées',
    'HR.POINTAGE.KIOSK.BUTTON_IN': 'Entrée',
    'HR.POINTAGE.KIOSK.BUTTON_OUT': 'Sortie',
    'HR.POINTAGE.KIOSK.DAY_COMPLETE': 'Pointage du jour terminé',
    'HR.POINTAGE.KIOSK.BACK_LIST': 'Liste des présences',
    'HR.POINTAGE.KIOSK.NO_JOB': 'Poste non renseigné'
  },
  ar: {
    'ADMIN.SEARCH': 'بحث',
    ...
    'HR.ATTENDANCE.FORM.ADD_BUTTON': 'إضافة حضور',
    'HR.ATTENDANCE.FORM.ADD_TITLE': 'إضافة حضور',
    'HR.ATTENDANCE.FORM.EDIT_TITLE': 'تعديل حضور',
    'HR.ATTENDANCE.FORM.SUBTITLE': 'إدخال يدوي لموظف (التاريخ، الدخول، الخروج).',
    'HR.ATTENDANCE.FORM.BREAK_MINUTES': 'استراحة (دقائق)',
    'HR.ATTENDANCE.FORM.NOTES': 'ملاحظات',
    'HR.ATTENDANCE.FORM.SAVE_SUCCESS': 'تم حفظ الحضور',
    'HR.ATTENDANCE.FORM.SAVE_ERROR': 'خطأ أثناء حفظ الحضور',
    'HR.ATTENDANCE.FORM.LOAD_ERROR': 'تعذر تحميل الحضور',
    'HR.ATTENDANCE.FORM.LOAD_EMPLOYEES_ERROR': 'تعذر تحميل قائمة الموظفين',
    'HR.ATTENDANCE.STATUS.LEAVE': 'إجازة',
    'HR.ATTENDANCE.STATUS.PUBLIC_HOLIDAY': 'عطلة رسمية',
    'HR.POINTAGE.KIOSK.MENU': 'تسجيل حضور الموظفين',
    'HR.POINTAGE.KIOSK.OPEN': 'فتح تسجيل الحضور',
    'HR.POINTAGE.KIOSK.TITLE': 'تسجيل الدخول / الخروج',
    'HR.POINTAGE.KIOSK.SUBTITLE': 'أدخل رقم بطاقة التعريف ثم سجّل دخولك أو خروجك.',
    'HR.POINTAGE.KIOSK.CIN_LABEL': 'رقم بطاقة التعريف',
    'HR.POINTAGE.KIOSK.CIN_REQUIRED': 'يرجى إدخال رقم بطاقة التعريف',
    'HR.POINTAGE.KIOSK.IDENTIFY': 'تحديد',
    'HR.POINTAGE.KIOSK.RESET': 'جديد',
    'HR.POINTAGE.KIOSK.EMPLOYEE_NOT_FOUND': 'لم يتم العثور على موظف لهذا الرقم',
    'HR.POINTAGE.KIOSK.LOAD_ERROR': 'تعذر تحميل الحضور',
    'HR.POINTAGE.KIOSK.PUNCH_ERROR': 'تم رفض التسجيل',
    'HR.POINTAGE.KIOSK.CHECK_IN_OK': 'تم تسجيل الدخول',
    'HR.POINTAGE.KIOSK.CHECK_OUT_OK': 'تم تسجيل الخروج',
    'HR.POINTAGE.KIOSK.TODAY': 'اليوم',
    'HR.POINTAGE.KIOSK.CHECK_IN': 'الدخول',
    'HR.POINTAGE.KIOSK.CHECK_OUT': 'الخروج',
    'HR.POINTAGE.KIOSK.WORKED_HOURS': 'ساعات العمل',
    'HR.POINTAGE.KIOSK.BUTTON_IN': 'تسجيل الدخول',
    'HR.POINTAGE.KIOSK.BUTTON_OUT': 'تسجيل الخروج',
    'HR.POINTAGE.KIOSK.DAY_COMPLETE': 'اكتمل تسجيل اليوم',
    'HR.POINTAGE.KIOSK.BACK_LIST': 'قائمة الحضور',
    'HR.POINTAGE.KIOSK.NO_JOB': 'لم يتم تحديد المنصب',
    'HR.POINTAGE.LOAD_ERROR': 'تعذر تحميل الحضور لهذا التاريخ.',
    'HR.POINTAGE.SAVE_ERROR': 'تعذر حفظ الحضور.',
    'HR.POINTAGE.ENTRY_MARKED': 'تم تسجيل الدخول في {{time}}.',
    'HR.POINTAGE.EXIT_MARKED': 'تم تسجيل الخروج في {{time}}.',
    'HR.POINTAGE.PUNCH': 'تسجيل',
    'HR.POINTAGE.OPEN_PUNCH': 'دخول مفتوح — سجّل الخروج أولاً'
  }
};
