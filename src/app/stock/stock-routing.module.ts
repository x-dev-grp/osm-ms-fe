...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        canActivate: [anyPermissionGuard([permissionKey(OOSMModule.INVENTAIR, InventoryEntity.BONCOMMANDE, Action.READ)])]
      },
      {
        path: 'bons-commande/nouveau',
        component: BcFormComponent,
        canActivate: [anyPermissionGuard([permissionKey(OOSMModule.INVENTAIR, InventoryEntity.BONCOMMANDE, Action.CREATE)])]
      },
      {
        path: 'bons-commande/:id/edit',
        component: BcFormComponent,
        canActivate: [anyPermissionGuard([permissionKey(OOSMModule.INVENTAIR, InventoryEntity.BONCOMMANDE, Action.UPDATE)])]
      },
      {
...

      {
        ...
        canActivate: [anyPermissionGuard([permissionKey(OOSMModule.INVENTAIR, InventoryEntity.MATERIEL_SUPPLIER, Action.READ)])]
      },
      {
        path: 'materiel-suppliers/nouveau',
        component: MaterielSupplierFormComponent,
        canActivate: [anyPermissionGuard([permissionKey(OOSMModule.INVENTAIR, InventoryEntity.MATERIEL_SUPPLIER, Action.CREATE)])]
      },
      {
      ...
      },
      {
        ...
        component: MaterielSupplierFormComponent,
        canActivate: [anyPermissionGuard([permissionKey(OOSMModule.INVENTAIR, InventoryEntity.MATERIEL_SUPPLIER, Action.UPDATE)])]
      },
      {
      ...
      },
      {
        path: 'skus',
        component: SkuListComponent,
        canActivate: [anyPermissionGuard([permissionKey(OOSMModule.INVENTAIR, InventoryEntity.SKU, Action.READ)])]
      },
      {
        path: 'skus/nouveau',
        component: SkuFormComponent,
        canActivate: [anyPermissionGuard([permissionKey(OOSMModule.INVENTAIR, InventoryEntity.SKU, Action.CREATE)])]
      },
      {
        path: 'skus/:id',
        component: SkuDetailComponent,
