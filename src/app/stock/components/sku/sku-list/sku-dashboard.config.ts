...
export const SKU_DASHBOARD_CONFIG: DashboardConfig = {
  icon: 'category',
  title: 'Gestion des Produits',
  titleTranslatePath: 'DASHBOARD_TITLES.PRODUCTS',
  baseURL: 'inventaire/products',
  searchEndpoint: 'inventaire/products',
  addNewItem: true,
  addNewItemUrl: '/stock/skus/nouveau',
  fileName: 'produits',
  specificActions: [
