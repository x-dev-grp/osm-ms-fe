...
export const LIGNE_DASHBOARD_CONFIG: DashboardConfig = {
  ...
  fields: [
    ...
    { name: 'responsable', label: 'Responsable', labelTranslatePath: 'DASHBOARD_FIELDS.RESPONSIBLE', attributeType: AttributeType.string, fieldType: FieldType.text, exportable: true, sortable: true, dataTable: true, filterable: true },
    { name: 'vitesseNominale', label: 'Vitesse', labelTranslatePath: 'DASHBOARD_FIELDS.SPEED', attributeType: AttributeType.number, fieldType: FieldType.number, exportable: true, sortable: true, dataTable: true, filterable: true },
    { name: 'etat', label: 'Etat', labelTranslatePath: 'DASHBOARD_FIELDS.STATE', attributeType: AttributeType.enum, fieldType: FieldType.select, exportable: true, sortable: true, dataTable: true, filterable: true },
