...
export const EMPLACEMENT_DASHBOARD_CONFIG: DashboardConfig = {
  ...
  fields: [
    ...
    },
    {
      name: 'zone',
      label: 'Zone',
      labelTranslatePath: 'DASHBOARD_FIELDS.ZONE',
      attributeType: AttributeType.string,
      fieldType: FieldType.text,
      exportable: true,
      sortable: true,
    ...
    },
    {
      ...
      labelTranslatePath: 'DASHBOARD_FIELDS.MAX_CAPACITY',
      attributeType: AttributeType.string,
      fieldType: FieldType.text,
      exportable: true,
      sortable: true,
    ...
    },
    {
      ...
      label: 'Capacite actuelle',
      labelTranslatePath: 'DASHBOARD_FIELDS.CURRENT_CAPACITY',
      attributeType: AttributeType.string,
      fieldType: FieldType.text,
      exportable: true,
      sortable: true,
