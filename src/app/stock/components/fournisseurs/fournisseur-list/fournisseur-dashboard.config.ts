...
export const FOURNISSEUR_DASHBOARD_CONFIG: DashboardConfig = {
  icon: 'local_shipping',
  title: 'Gestion des Fournisseurs',
  titleTranslatePath: 'DASHBOARD_TITLES.SUPPLIERS',
  baseURL: 'inventaire/fournisseurs',
  searchEndpoint: 'inventaire/fournisseurs',
  addNewItem: true,
  addNewItemUrl: '/stock/fournisseurs/nouveau',
  ...
  fields: [
    ...
    { name: 'categorieFournisseur', label: 'Categorie', labelTranslatePath: 'DASHBOARD_FIELDS.CATEGORY', attributeType: AttributeType.enum, fieldType: FieldType.select, exportable: true, sortable: true, dataTable: true, filterable: true },
