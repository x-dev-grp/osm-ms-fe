...
import { Action, HREntity, OOSMModule, permissionKey } from 'src/app/theme/types/permissions';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        canActivate: [AuthGuardChild, allPermissionGuard([permissionKey(OOSMModule.HR, HREntity.DEPARTMENT, Action.READ)])]
      },
      {
        path: 'contract',
      ...
      },
      {
        ...
        canActivate: [AuthGuardChild, allPermissionGuard([permissionKey(OOSMModule.HR, HREntity.DEPARTMENT, Action.CREATE)])]
      },
      {
        path: 'poste/new',
      ...
      },
      {
        ...
        canActivate: [AuthGuardChild, allPermissionGuard([permissionKey(OOSMModule.HR, HREntity.DEPARTMENT, Action.UPDATE)])]
      },
