...
import { Action, FinanceEntity, OOSMModule, permissionKey, ProductionEntity } from 'src/app/theme/types/permissions';
...
const routes: Routes = [
  ...
  // CHANGE: permissions - Expenses
  {
    ...
    canActivate: [AuthGuardChild, allPermissionGuard([permissionKey(OOSMModule.FINANCE, FinanceEntity.EXPENSE, Action.READ)])]
  },
  {
  ...
  },
  {
    ...
    canActivate: [AuthGuardChild, allPermissionGuard([permissionKey(OOSMModule.FINANCE, FinanceEntity.EXPENSE, Action.CREATE)])]
  },
  {
    path: 'expenses/:id/edit',
    loadComponent: () => import('./expenses/expense-add/expense-add.component').then((m) => m.ExpenseAddComponent),
    canActivate: [AuthGuardChild, allPermissionGuard([permissionKey(OOSMModule.FINANCE, FinanceEntity.EXPENSE, Action.UPDATE)])]
  },
  // CHANGE: permissions - Bank Accounts
  {
    path: 'banks',
    component: BankAccountsComponent,
    canActivate: [AuthGuardChild, allPermissionGuard([permissionKey(OOSMModule.FINANCE, FinanceEntity.BANKACCOUNT, Action.READ)])]
  },
  {
    path: 'banks/:id/view',
  ...
  },
  {
    ...
    canActivate: [AuthGuardChild, allPermissionGuard([permissionKey(OOSMModule.FINANCE, FinanceEntity.BANKACCOUNT, Action.CREATE)])]
  },
  {
    path: 'banks/:id/edit',
    loadComponent: () => import('./bank-accounts/bank-account-add/bank-account-add.component').then((m) => m.BankAccountAddComponent),
    canActivate: [AuthGuardChild, allPermissionGuard([permissionKey(OOSMModule.FINANCE, FinanceEntity.BANKACCOUNT, Action.UPDATE)])]
  },
  ...
  },
  {
    ...
    canActivate: [AuthGuardChild, allPermissionGuard([permissionKey(OOSMModule.FINANCE, FinanceEntity.FINANCIALTRANSACTION, Action.CREATE)])]
  },
  {
    path: 'transactions/:id/edit',
    loadComponent: () => import('./transactions/transaction-add/transaction-add.component').then((m) => m.TransactionAddComponent),
    canActivate: [AuthGuardChild, allPermissionGuard([permissionKey(OOSMModule.FINANCE, FinanceEntity.FINANCIALTRANSACTION, Action.UPDATE)])]
  },
  ...
  },
  {
    ...
    canActivate: [AuthGuardChild, allPermissionGuard([permissionKey(OOSMModule.FINANCE, FinanceEntity.OILSALE, Action.CREATE)])]
  },
  {
    path: 'oil-sales/:id/edit',
    loadComponent: () => import('./oil-sales/oil-sale-add/oil-sale-add.component').then((m) => m.OilSaleAddComponent),
    canActivate: [AuthGuardChild, allPermissionGuard([permissionKey(OOSMModule.FINANCE, FinanceEntity.OILSALE, Action.UPDATE)])]
  },
  {
