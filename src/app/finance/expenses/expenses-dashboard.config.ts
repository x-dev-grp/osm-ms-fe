    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          value: ExpenseCategory.PLUMBING_MATERIALS,
          labelTranslatePath: 'EXPENSE.CATEGORY.PLUMBING_MATERIALS'
        },
        {
        ...
        {
          label: 'Lab & analysis fees',
          value: ExpenseCategory.LAB_ANALYSIS_FEES,
          labelTranslatePath: 'EXPENSE.CATEGORY.LAB_ANALYSIS_FEES'
        },
        {
        ...
        {
          label: 'Factory consumables',
          value: ExpenseCategory.FACTORY_CONSUMABLES,
          labelTranslatePath: 'EXPENSE.CATEGORY.FACTORY_CONSUMABLES'
        },
        {
          label: 'Tolls & road fees',
          value: ExpenseCategory.TOLLS_AND_ROAD_FEES,
          labelTranslatePath: 'EXPENSE.CATEGORY.TOLLS_AND_ROAD_FEES'
        },
        {
