...
export const CLIENT_DASHBOARD_CONFIG: DashboardConfig = {
  ...
  fields: [
    { name: 'codeClient', label: 'Code', labelTranslatePath: 'DASHBOARD_FIELDS.CODE', attributeType: AttributeType.string, fieldType: FieldType.text, exportable: true, sortable: true, dataTable: true, filterable: true },
