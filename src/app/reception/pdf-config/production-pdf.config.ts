...
export function getProductionPdfConfig(data: UnifiedDelivery, parameters: any): PdfConfig {
  ...
  return {
    ...
    titleTranslatePath: 'AUTO.PDF_PRODUCTION_RECEIPT',
    ...
    generalInfo: [
      { label: 'PDF.LOT_NUMBER',
        labelTranslatePath: 'AUTO.PDF_LOT_NUMBER', value: data.globalLotNumber || data.lotNumber || '-' },
      { label: 'PDF.RECEPTION_NUMBER',
        labelTranslatePath: 'AUTO.PDF_RECEPTION_NUMBER', value: data.deliveryNumber || '-' },
      {
        label: 'PDF.SUPPLIER',
      ...
      { label: 'PDF.REGION',
        labelTranslatePath: 'AUTO.PDF_REGION', value: data.region?.name || '-' },
      { label: 'PDF.OLIVE_VARIETY',
        labelTranslatePath: 'AUTO.PDF_OLIVE_VARIETY', value: data.oliveVariety?.name || '-' },
      { label: 'PDF.OLIVE_TYPE',
        labelTranslatePath: 'AUTO.PDF_OLIVE_TYPE', value: data.oliveType || '-' }
    ],
    fields: [
      {label: 'PDF.CRUSHING_DATE',
       labelTranslatePath: 'AUTO.PDF_CRUSHING_DATE', value: dateTrituration},
      {label: 'DELIVERIES.FIELDS.OLIVE_QUANTITY',
       labelTranslatePath: 'AUTO.DELIVERIES_FIELDS_OLIVE_QUANTITY', value: `${qteOlive} kg`},
      {label: 'PDF.OIL_QUANTITY',
       labelTranslatePath: 'AUTO.PDF_OIL_QUANTITY', value: `${qteHuile} kg`},
      { label: 'PDF.YIELD',
        labelTranslatePath: 'AUTO.PDF_YIELD', value: `${rendement.toFixed(3)} %` },
      {label: 'CONTROLE_QUALITE.STORAGE_UNIT.LABEL',
       labelTranslatePath: 'AUTO.CONTROLE_QUALITE_STORAGE_UNIT_LABEL', value: `${storageunit} `},
    ...
    footerInfo: [
      {label: 'PDF.QUALITY_MANAGER',
       labelTranslatePath: 'AUTO.PDF_QUALITY_MANAGER'},
      {label: 'PDF.PRODUCTION_MANAGER',
       labelTranslatePath: 'AUTO.PDF_PRODUCTION_MANAGER'},
      {label: 'PDF.SIGNATURE',
       labelTranslatePath: 'AUTO.PDF_SIGNATURE'},
      {label: 'PDF.DATE',
