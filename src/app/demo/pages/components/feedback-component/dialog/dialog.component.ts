...
import { MatDialog, MatDialogRef, MAT_DIALOG_DATA, MatDialogActions, MatDialogClose, MatDialogContent } from '@angular/material/dialog';
...
export class DialogAnimationsComponent {
  dialogRef = inject<MatDialogRef<DialogAnimationsComponent>>(MatDialogRef);
}
...
@Component({
  ...
  `,
  imports: [MatDivider, CdkScrollable, MatDialogContent, MatDialogActions, MatButton, MatDialogClose]
})
export class DialogAnimationsScrollComponent {
  dialogRef = inject<MatDialogRef<DialogAnimationsScrollComponent>>(MatDialogRef);
}
...
@Component({
  ...
  `,
  imports: [MatDivider, CdkScrollable, MatDialogContent]
})
...
export class DialogAnimationsElementComponent {
  dialogRef = inject<MatDialogRef<DialogAnimationsElementComponent>>(MatDialogRef);
}
